...
public class RegistrationDeleteConsumer
{
    ...
    @Autowired
    public RegistrationDeleteConsumer(ObjectMapper givenObjectMapper, IAccountRepository accountRepository)
    {
    ...
    public void consume(String jsonEvent) {
        try
        {
            ...
            LOGGER.info(String.format("User created event received in project service => %s", accountId.toString()));
        }
